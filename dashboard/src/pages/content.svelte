...
<section class="editor" bind:this={codeSection} />
...
<style unscoped>
  ...
  :root {
    --cm-border-color: var(--border-color);
    --cm-background-color: var(--neutral-color);
    --cm-medium-color: var(--border-color);
    --cm-text-color: var(--text-color);
  }
